...
INSERT INTO "new_Household" ("createdAt", "createdById", "id", "name", "progressBarColor", "rewardThreshold", "timeZone", "updatedAt") SELECT "createdAt", "createdById", "id", "name", "progressBarColor", "rewardThreshold", "timeZone", "updatedAt" FROM "Household";
